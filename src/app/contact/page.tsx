...
export default function ContactPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <PageHeader title="Contact Us" description="Have questions or want to get involved? Reach out to our team." />
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="media">Media Inquiry</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="partnership" id="partnership" />
                      <Label htmlFor="partnership">Partnership Proposal</Label>
                    </div>
                  </RadioGroup>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="subscribe">Subscribe to our newsletter for updates on nuclear disarmament</Label>
                </div>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-slate-600">info@nucleardisarmament.org</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
